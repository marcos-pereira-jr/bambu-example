        ...
        <div class="container">
            ...
            <div class="login-container">
                <form>
                    ...
                    <div :class="['input-div two', { focus: isFocusPass }]">
                        <div class="i">
...
/* alem de usar display grid para alinhar o icone em fração de 7% e 93% com borda*/
.input-div {
    position: relative;
    display: grid;
...
/* tornar os filhos imediatos em uma posição relativa */
.input-div > div {
    position: relative;
    height: 45px;
}
